(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const S of document.querySelectorAll('link[rel="modulepreload"]'))c(S);new MutationObserver(S=>{for(const A of S)if(A.type==="childList")for(const q of A.addedNodes)q.tagName==="LINK"&&q.rel==="modulepreload"&&c(q)}).observe(document,{childList:!0,subtree:!0});function f(S){const A={};return S.integrity&&(A.integrity=S.integrity),S.referrerPolicy&&(A.referrerPolicy=S.referrerPolicy),S.crossOrigin==="use-credentials"?A.credentials="include":S.crossOrigin==="anonymous"?A.credentials="omit":A.credentials="same-origin",A}function c(S){if(S.ep)return;S.ep=!0;const A=f(S);fetch(S.href,A)}})();function mb(o){return o&&o.__esModule&&Object.prototype.hasOwnProperty.call(o,"default")?o.default:o}var gr={exports:{}},Ne={};/**
 * @license React
 ...
 */var Od;function vb(){if(Od)return Ne;Od=1;var o=Symbol.for("react.transitional.element"),s=Symbol.for("react.fragment");function f(c,S,A){var q=null;if(A!==void 0&&(q=""+A),S.key!==void 0&&(q=""+S.key),"key"in S){A={};for(var w in S)w!=="key"&&(A[w]=S[w])}else A=S;return S=A.ref,{$$typeof:o,type:c,key:q,ref:S!==void 0?S:null,props:A}}return Ne.Fragment=s,Ne.jsx=f,Ne.jsxs=f,Ne}var _d;function pb(){return _d||(_d=1,gr.exports=vb()),gr.exports}var R=pb(),yr={exports:{}},$={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Dd;function Sb(){if(Dd)return Jn;Dd=1;var o=Dr();function s(D){var x="https://react.dev/errors/"+D;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var M=2;M<arguments.length;M++)x+="&args[]="+encodeURIComponent(arguments[M])}return"Minified React error #"+D+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function f(){}var c={d:{f,r:function(){throw Error(s(522))},D:f,C:f,L:f,m:f,X:f,S:f,M:f},p:0,findDOMNode:null},S=Symbol.for("react.portal");function A(D,x,M){var W=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:S,key:W==null?null:""+W,children:D,containerInfo:x,implementation:M}}var q=o.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function w(D,x){if(D==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return Jn.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,Jn.createPortal=function(D,x){var M=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(s(299));return A(D,x,null,M)},Jn.flushSync=function(D){var x=q.T,M=c.p;try{if(q.T=null,c.p=2,D)return D()}finally{q.T=x,c.p=M,c.d.f()}},Jn.preconnect=function(D,x){typeof D=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,c.d.C(D,x))},Jn.prefetchDNS=function(D){typeof D=="string"&&c.d.D(D)},Jn.preinit=function(D,x){if(typeof D=="string"&&x&&typeof x.as=="string"){var M=x.as,W=w(M,x.crossOrigin),K=typeof x.integrity=="string"?x.integrity:void 0,hn=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;M==="style"?c.d.S(D,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:W,integrity:K,fetchPriority:hn}):M==="script"&&c.d.X(D,{crossOrigin:W,integrity:K,fetchPriority:hn,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},Jn.preinitModule=function(D,x){if(typeof D=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var M=w(x.as,x.crossOrigin);c.d.M(D,{crossOrigin:M,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&c.d.M(D)},Jn.preload=function(D,x){if(typeof D=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var M=x.as,W=w(M,x.crossOrigin);c.d.L(D,M,{crossOrigin:W,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},Jn.preloadModule=function(D,x){if(typeof D=="string")if(x){var M=w(x.as,x.crossOrigin);c.d.m(D,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:M,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else c.d.m(D)},Jn.requestFormReset=function(D){c.d.r(D)},Jn.unstable_batchedUpdates=function(D,x){return D(x)},Jn.useFormState=function(D,x,M){return q.H.useFormState(D,x,M)},Jn.useFormStatus=function(){return q.H.useHostTransitionStatus()},Jn.version="19.1.0",Jn}var Md;function Ob(){if(Md)return _r.exports;Md=1;function o(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(o)}catch(s){console.error(s)}}return o(),_r.exports=Sb(),_r.exports}/**
 * @license React
...
}`);Array.from({length:4},function(o,s){return"--life-line-phase".concat(s+1,"-color")});const J1=({searchQuery:o,genre:s})=>{const[f,c]=$n.useState([]),[S,A]=$n.useState("PENDING"),[q,w]=$n.useState(null),[D,x]=$n.useState(""),[M,W]=$n.useState(!0),[K,hn]=$n.useState(11),L=f.slice(0,K),N=[5,10,20,30,40];return $n.useEffect(()=>{if(o===""){c([]),x(""),A("SUCCESS");return}const Y=s!=null,qn=Y?`subject:${s}`:o||"computers";console.log("Query being used:",qn),!Y&&o&&!M?x(o):(M||Y)&&x(""),A("LOADING"),Fb(qn).then(pn=>{c(pn),A("SUCCESS"),M&&W(!1)}).catch(pn=>{console.error("Error Fetching books:",pn),w(pn),A("FAILED"),M&&W(!1)})},[o,s,M]),M&&S==="LOADING"?R.jsx("div",{className:Ta.loading,children:R.jsx(K1,{color:["#3a4a3d","#a7c957","#bc4749","#1d384a"],size:"large",text:"loading books...",textColor:""})}):S==="FAILED"?R.jsx("div",{className:Ta.error,children:R.jsxs("p",{children:["Failed to load books: ",(q==null?void 0:q.message)||"Unknown error"]})}):(!f||f.length===0)&&!M?R.jsx("div",{className:Ta.error,children:R.jsx("p",{children:"No results found. Please type in search or choose genre "})}):R.jsxs(R.Fragment,{children:[D&&R.jsx("div",{className:Ta.searchInfo,children:R.jsxs("h3",{children:["search result for:","  ",R.jsx("span",{className:Ta.queryText,children:D})]})}),f.length>0&&R.jsxs("div",{className:Ta.displayOptions,children:[R.jsx("span",{children:"Show books per page: "}),N.map(Y=>R.jsx("button",{onClick:()=>hn(Y),className:`${Ta.countButton} ${K===Y?Ta.activeCount:""}`,children:Y},Y))]}),R.jsx(E1,{books:L})]})},P1="_container_1ccku_1",$1="_title_1ccku_6",W1="_buttonContainer_1ccku_12",F1="_genreButton_1ccku_21",I1="_active_1ccku_41",qe={container:P1,title:$1,buttonContainer:W1,genreButton:F1,active:I1},nm=({onSelectGenre:o,activeGenre:s})=>{const f=["fiction","programming","science fiction","history","self-help","romance","biography","thriller","fantasy","health","travel","cookbook","medicine","philosophy","psychology"];return R.jsxs("div",{className:qe.container,children:[R.jsx("h3",{className:qe.title,children:"Popular Genres"}),R.jsx("div",{className:qe.buttonContainer,children:f.map(c=>R.jsx("button",{className:`${qe.genreButton} ${c===s?qe.active:""}`,onClick:()=>o(c),children:c},c))})]})};function tm(){const[o,s]=$n.useState(null),[f,c]=$n.useState(null),[S,A]=$n.useState(1),[q,w]=$n.useState(10),D=M=>{s(M),c(null)},x=M=>{c(M),s(null)};return R.jsxs(Pb,{children:[R.jsx(Cb,{onSearch:D})," ",R.jsx(nm,{onSelectGenre:x,activeGenre:f}),R.jsx(J1,{searchQuery:o,genre:f})]})}Ab.createRoot(document.getElementById("root")).render(R.jsx($n.StrictMode,{children:R.jsx(tm,{})}));
